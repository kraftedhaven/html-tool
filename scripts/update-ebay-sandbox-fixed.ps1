...
Write-Host "5. Copy the following values:" -ForegroundColor Yellow
Write-Host ""
...
Write-Host ""
Write-Host "⚠️ For the Sandbox User Token:" -ForegroundColor Red
...
Write-Host ""
Write-Host "🧪 Testing eBay Sandbox Connection..." -ForegroundColor Yellow
...
Write-Host ""
Write-Host "📝 Creating Sandbox Policies (if needed)..." -ForegroundColor Yellow
